...
#
# MRCMS Template Version 1.1.0 => 1.2.0
#
# Execute in web2py folder after code upgrade like:
# python web2py.py -S eden -M -R applications/eden/modules/templates/MRCMS/upgrade/1.1.0-1.2.0.py
#
import sys
...
# -----------------------------------------------------------------------------
# Deploy service contact types
#
if not failed:
    info("Deploy service contact types")
